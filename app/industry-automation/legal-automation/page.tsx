...
const solutions = [
  {
    ...
    description: "Capture new client enquiries 24/7 with intelligent intake forms. AI qualifies cases, gathers essential information, and routes to the right solicitor automatically.",
    features: [
      "24/7 enquiry capture",
      "Automatic case qualification",
      "Conflict of interest checks",
      "Smart solicitor routing"
    ]
  },
  {
    icon: FileText,
    title: "Claims Data Collection",
    description: "Streamline the claims process with automated data gathering. Collect incident details, witness information, and key dates through guided conversational flows.",
    features: [
  ...
  {
    icon: Upload,
    title: "Evidence Upload Flows",
    description: "Secure, guided evidence submission for clients. Medical records, photographs, correspondence—all collected systematically with proper categorisation.",
    features: [
...
const benefits = [
  {
    ...
    description: "Never miss a potential client—capture enquiries 24/7, weekends and holidays."
  },
  {
    icon: Shield,
    title: "SRA & GDPR Compliant",
    description: "Built with legal compliance in mind. Secure, auditable, and professional."
  },
  {
    icon: Users,
    title: "Reduce Admin Load",
    description: "Free up fee earners from repetitive data collection and chasing clients."
  },
  {
    icon: Zap,
    title: "Faster Case Progression",
    description: "Get cases matter-ready faster with complete information from day one."
  }
];
...
const workflows = [
  {
    ...
    description: "Client submits enquiry via web, phone, or referral."
  },
  {
    step: "02",
    title: "AI Qualifies",
    description: "Intelligent questions determine case type and viability."
  },
  {
    step: "03",
    title: "Data Collected",
    description: "Claims details, evidence, and documents gathered systematically."
  },
  {
    step: "04",
    title: "Case Ready",
    description: "Complete file delivered to assigned solicitor for review."
  }
];
...
const complianceFeatures = [
  ...
  { icon: FolderOpen, label: "Secure Storage" },
...
export default function LawFirmsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">AI for Legal Services</span>
            </motion.div>
            ...
            >
              Automate case intake, claims data collection, and evidence gathering.
              Let AI handle the admin while your solicitors focus on winning cases.
            </motion.p>
      ...
      <section id="solutions" className="py-20 md:py-28 bg-gray-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Solutions Built for Legal Practices
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              Every automation designed with legal compliance and client confidentiality in mind
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <motion.h2
              ...
              className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
            >
              From Enquiry to Matter-Ready File
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              See how AI automation streamlines your intake process
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 bg-black text-white overflow-hidden relative">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Trusted by solicitors across the UK to handle sensitive client data
            </motion.p>
          </motion.div>
      ...
      {/* Compliance & Security Section - Unique to Law Firms */}
          ...
          >
            <motion.div variants={fadeInLeft}>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Client confidentiality isn&apos;t optional. Our systems are designed from the ground up
                to meet SRA standards and GDPR requirements. Every interaction is logged,
                encrypted, and fully auditable.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">
              Trusted by firms across practice areas
            </p>
          </motion.div>
          <motion.div
          ...
          >
            {[
              { icon: Gavel, name: "Personal Injury" },
              { icon: Scale, name: "Family Law" },
              { icon: BookOpen, name: "Conveyancing" },
              { icon: FileText, name: "Wills & Probate" },
              { icon: Users, name: "Employment" },
              { icon: Shield, name: "Commercial" },
            ].map((area) => (
              <motion.div
                key={area.name}
                variants={fadeInUp}
      ...
      <section className="py-20 md:py-28 bg-white overflow-hidden relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            >
              Join forward-thinking law firms who are capturing more clients
      ...
      <RelatedIndustries currentPath="/industry-automation/legal-automation" />
    </div>
  );
}
