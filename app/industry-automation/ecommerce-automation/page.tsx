                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-500 mb-8 leading-relaxed max-w-lg">
                            From inventory alerts to customer support ticketing. Let AI handle the logistics while you focus on growth.
                        </p>
                    ...
                    >
                        <img
                            src="/images/industries/ecommerce-automation.png"
                        ...
                        {[
                            {
                                ...
                                desc: "Get low-stock alerts and automatically reorder best-sellers before they run out.",
                            },
                            {
                                title: "Customer Support",
                                desc: "Resolve 60% of tickets automatically with AI agents that handle returns and status checks.",
                            },
                            {
                                title: "Order Tracking",
                                desc: "Proactively notify customers about shipping delays to reduce anxiety and support volume.",
                            },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
