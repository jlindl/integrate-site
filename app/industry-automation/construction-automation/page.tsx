...
const solutions = [
  {
    ...
    description: "Capture job enquiries 24/7 with intelligent quote request forms. Collect project details, site information, and specifications automatically—ready for your estimator.",
    features: [
      "24/7 enquiry capture",
      "Project scope collection",
      "Photo/document uploads",
      "Automatic job categorisation"
    ]
  },
  {
    icon: Calendar,
    title: "Smart Job Scheduling",
    description: "Automate appointment booking and crew scheduling. Clients book available slots, teams get notified, and calendars stay synced—no more back-and-forth calls.",
    features: [
  ...
  {
    icon: Shield,
    title: "Health & Safety Data Collection",
    description: "Digital H&S forms, site inductions, and RAMS collection. Keep compliance records organised and accessible with automated filing and reminders.",
    features: [
  ...
  {
    icon: Bell,
    title: "Renewal & Certification Reminders",
    description: "Never miss a certification renewal again. Automated reminders for gas safety, electrical certs, insurance, and trade accreditations.",
    features: [
...
const benefits = [
  {
    ...
    description: "Eliminate paperwork and admin that eats into billable time."
  },
  {
    icon: FileCheck,
    title: "Always Compliant",
    description: "H&S records, certs, and documentation always up to date."
  },
  {
    icon: Users,
    title: "Win More Jobs",
    description: "Respond to enquiries instantly—even from site or after hours."
  },
  {
    icon: Zap,
    title: "Go Live in Days",
    description: "Simple setup that works with your existing tools and processes."
  }
];
...
const workflows = [
  {
    ...
    description: "Customer submits quote request online or by phone."
  },
  {
    step: "02",
    title: "Details Captured",
    description: "AI collects project specs, photos, and site access info."
  },
  {
    step: "03",
    title: "Job Scheduled",
    description: "Site visit or work booked into available calendar slots."
  },
  {
    step: "04",
    title: "Docs Handled",
    description: "H&S forms, quotes, and invoices automated end-to-end."
  }
];

const paperworkStats = [
  { value: "15+", label: "Hours saved weekly" },
  { value: "100%", label: "Cert compliance" },
...
export default function ConstructionTradesPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">AI for Construction & Trades</span>
            </motion.div>
            ...
            >
              Quote intake, job scheduling, H&S documentation, and renewal reminders—all
              automated. Spend less time on admin, more time on the tools.
            </motion.p>
      ...
      <section id="solutions" className="py-20 md:py-28 bg-gray-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Solutions Built for the Trades
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              Every automation designed to cut admin and keep you compliant
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            <motion.p
              ...
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              See how AI handles the admin so you can focus on the job
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 bg-black text-white overflow-hidden relative">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Built for builders, plumbers, electricians, and contractors across the UK
            </motion.p>
          </motion.div>
      ...
      {/* Paperwork Stats Section - Unique to Construction */}
          ...
          >
            <motion.div variants={fadeInLeft}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Automation Heaven for the Trades
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Tons of manual paperwork? That&apos;s exactly why automation works so well
                for construction and trades. Every form, every reminder, every
                booking—handled automatically while you&apos;re on site getting the job done.
              </p>
              <div className="space-y-4">
                {[
                  "Quote requests captured while you're on the tools",
                  "H&S documentation filed and organised automatically",
                  "Certification renewals—never miss another deadline",
                  "Client communications handled professionally 24/7"
                ].map((point, index) => (
                  <motion.div
                    key={point}
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            {[
              ...
              { icon: Truck, name: "Contractors" },
              { icon: AlertTriangle, name: "Gas Engineers" },
              { icon: FileText, name: "Surveyors" },
            ].map((trade) => (
              <motion.div
                key={trade.name}
                variants={fadeInUp}
      ...
      <section className="py-20 md:py-28 bg-white overflow-hidden relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            >
              Join forward-thinking tradespeople who are winning more jobs
              and spending less time on admin. Book a free demo today.
            </motion.p>
            <motion.div
              variants={fadeInUp}
      ...
      <RelatedIndustries currentPath="/industry-automation/construction-automation" />
    </div>
  );
}
