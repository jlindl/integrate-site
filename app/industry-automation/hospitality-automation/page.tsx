...
const solutions = [
  {
    icon: Calendar,
    title: "Smart Booking Handling",
    description: "Automate reservations, event enquiries, and table bookings 24/7. AI handles availability checks, special requests, and confirmations—freeing your team to focus on guests.",
    features: [
  ...
  {
    icon: CreditCard,
    title: "Seamless Payment Flows",
    description: "Collect deposits, process payments, and handle refunds automatically. Secure payment links, split billing, and automated invoicing for corporate events.",
    features: [
      "Deposit collection",
  ...
  },
  {
    ...
    description: "Streamline shift scheduling, availability collection, and team communications. Staff confirm shifts via SMS, swaps are managed automatically, and gaps get flagged.",
    features: [
      "Shift scheduling",
  ...
  },
  {
    ...
    description: "Boost your online reputation with perfectly timed review requests. Trigger post-visit emails and SMS, direct happy guests to Google and TripAdvisor.",
    features: [
      "Timed review triggers",
...
const benefits = [
  {
    ...
    description: "Automate bookings, payments, and staff coordination."
  },
  {
    icon: Star,
    title: "5-Star Reputation",
    description: "Automated review requests boost your online ratings."
  },
  {
    icon: Users,
    title: "Happier Staff",
    description: "Easy shift management and clear communications."
  },
  {
    icon: Zap,
    title: "Go Live in Days",
    description: "Quick setup that works with your existing systems."
  }
];
...
const workflows = [
  {
    ...
    description: "Guest makes a booking request online or by phone."
  },
  {
    step: "02",
    title: "AI Confirms",
    description: "Availability checked, details captured, booking confirmed."
  },
  {
    step: "03",
    title: "Payment Collected",
    description: "Deposits and payments handled securely and automatically."
  },
  {
    step: "04",
    title: "Review Requested",
    description: "Post-visit follow-up triggers review requests."
  }
];
...
export default function HospitalityEventsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">AI for Hospitality & Events</span>
            </motion.div>
            ...
            >
              Booking handling, payments, staff coordination, and review requests—all
              automated. Deliver exceptional service while reducing operational overhead.
            </motion.p>
      ...
      <section id="solutions" className="py-20 md:py-28 bg-gray-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Solutions Built for Hospitality
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              Every automation designed to enhance guest experience and streamline operations
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <motion.h2
              ...
              className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
            >
              From Enquiry to 5-Star Review
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              See how AI automation enhances every touchpoint of the guest journey
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 bg-black text-white overflow-hidden relative">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Trusted by restaurants, hotels, and event venues across the UK
            </motion.p>
          </motion.div>
      ...
      {/* Stats Section - Unique to Hospitality */}
          ...
          >
            <motion.div variants={fadeInLeft}>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                In hospitality, every minute counts. Automating bookings, payments, and staff
                coordination frees your team to do what they do best—create memorable experiences
                for your guests.
              </p>
              <div className="space-y-4">
                {[
                  "Never miss a booking—even at 2am on a Saturday",
                  "Deposits collected automatically, no awkward chasing",
                  "Staff shifts filled and confirmed without phone tag",
                  "Reviews requested at the perfect moment post-visit"
                ].map((point, index) => (
                  <motion.div
                    key={point}
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            {[
              ...
              { icon: Bed, name: "Hotels" },
              { icon: Wine, name: "Bars & Pubs" },
              { icon: PartyPopper, name: "Event Venues" },
              { icon: Music, name: "Nightclubs" },
              { icon: MapPin, name: "Cafés" },
            ].map((venue) => (
              <motion.div
                key={venue.name}
                variants={fadeInUp}
      ...
      <section className="py-20 md:py-28 bg-white overflow-hidden relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            >
              Join forward-thinking venues who are delivering better guest experiences
              while reducing operational burden. Book a free demo today.
            </motion.p>
            <motion.div
              variants={fadeInUp}
