...
const solutions = [
  {
    ...
    description: "Automatically capture leads from your website, social media, and referral partners. Our AI qualifies prospects based on income, credit profile, and property requirements.",
    features: [
  ...
  },
  {
    ...
    description: "Let clients book consultations directly into your calendar. Smart scheduling considers your availability, travel time, and meeting preferences.",
    features: [
  ...
  },
  {
    ...
    description: "Never miss a remortgage opportunity. Track renewal dates across your client base and trigger personalised outreach at the perfect time.",
    features: [
      "Automated renewal alerts",
      "6-month advance notifications",
...
const benefits = [
  {
    ...
    description: "Automate repetitive tasks and focus on high-value client conversations."
  },
  {
    icon: TrendingUp,
    title: "Increase Conversion by 40%",
    description: "Faster response times and consistent follow-ups mean more deals closed."
  },
  {
    icon: Shield,
    title: "FCA Compliant",
    description: "All automations designed with UK regulatory requirements in mind."
  },
  {
    icon: Zap,
...
const workflows = [
  {
    step: "01",
    title: "Lead Arrives",
    description: "Website form, Facebook ad, or referral partner sends a new enquiry."
  },
  {
    step: "02",
    title: "AI Qualifies",
    description: "Automated questions gather income, deposit, and property details."
  },
  {
    step: "03",
    title: "Appointment Booked",
    description: "Qualified leads book directly into your calendar with all info attached."
  },
  {
    step: "04",
    title: "You Close",
    description: "Walk into every meeting fully prepared with a pre-qualified client."
  }
];
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">AI for Mortgage Brokers</span>
            </motion.div>
            ...
            >
              Automate lead qualification, appointment booking, and renewal tracking.
              Spend less time on admin and more time helping clients find their perfect mortgage.
            </motion.p>
      ...
      <section id="solutions" className="py-20 md:py-28 bg-gray-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Solutions Built for Brokers
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              Every automation designed specifically for the mortgage industry workflow
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <motion.h2
              ...
              className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
            >
              From Lead to Close, Automated
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              See how a typical lead flows through your automated pipeline
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 bg-black text-white overflow-hidden relative">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Real results from real mortgage professionals
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 bg-white overflow-hidden relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            >
              Join forward-thinking mortgage brokers who are closing more deals
