...
const solutions = [
  {
    ...
    description: "Let patients book appointments 24/7 through intelligent online scheduling. AI handles availability, practitioner matching, and appointment types—reducing reception workload by 60%.",
    features: [
      "24/7 online booking",
  ...
  },
  {
    ...
    description: "Digital patient registration and medical history collection before appointments. Patients complete forms at home, arriving ready for their consultation.",
    features: [
  ...
  {
    icon: CreditCard,
    title: "Insurance Pre-Checks",
    description: "Automate insurance verification before appointments. Confirm coverage, check policy details, and flag any issues—preventing billing surprises for patients and clinics.",
    features: [
...
const benefits = [
  {
    icon: Clock,
    title: "60% Less Admin",
    description: "Cut reception workload with automated booking and intake."
  },
  {
    icon: Shield,
    title: "CQC & GDPR Ready",
    description: "Built for healthcare compliance from the ground up."
  },
  {
    icon: Users,
    title: "Better Patient Experience",
    description: "No hold times, no paper forms, seamless check-in."
  },
  {
    icon: Zap,
    title: "Go Live in Days",
    description: "Quick integration with existing practice management systems."
  }
];
...
const workflows = [
  {
    ...
    description: "New or existing patient visits your booking page."
  },
  {
    step: "02",
    title: "AI Books",
    description: "Appointment scheduled with the right practitioner."
  },
  {
    step: "03",
    title: "Data Collected",
    description: "Patient completes intake forms before arrival."
  },
  {
    step: "04",
    title: "Insurance Verified",
    description: "Coverage confirmed, patient arrives ready for care."
  }
];

const complianceFeatures = [
  { icon: Lock, label: "NHS-Grade Security" },
  { icon: Shield, label: "CQC Compliant" },
  { icon: FileText, label: "Full Audit Trail" },
  { icon: Heart, label: "Patient Consent" },
...
export default function HealthcarePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">AI for Healthcare</span>
            </motion.div>
            ...
            >
              Appointment booking, patient intake, and insurance verification—all 
              automated. Less admin, better patient experience, more time for care.
            </motion.p>
      ...
      <section id="solutions" className="py-20 md:py-28 bg-gray-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Every automation designed with patient care and compliance in mind
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <motion.h2 
              ...
              className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
            >
              From Enquiry to Care—Seamlessly
            </motion.h2>
            <motion.p 
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              See how AI streamlines the entire patient journey
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 bg-black text-white overflow-hidden relative">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Trusted by clinics and private practices across the UK
            </motion.p>
          </motion.div>
      ...
      {/* Stats & Compliance Section - Unique to Healthcare */}
          ...
          >
            <motion.div variants={fadeInLeft}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                High ROI for Healthcare
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Private healthcare providers are surprisingly high spenders on automation—and 
                for good reason. The ROI is exceptional when you factor in reduced no-shows, 
                lower admin costs, and improved patient satisfaction scores.
              </p>
              <div className="space-y-4">
                {[
                  "60% reduction in reception admin workload",
                  "40% fewer no-shows with automated reminders",
                  "Insurance verified before patient arrives",
                  "Patients complete forms at home, not in waiting room"
                ].map((point, index) => (
                  <motion.div
                    key={point}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Healthcare-Grade Security & Compliance</h3>
            <p className="text-sm text-gray-500">Built to meet the highest standards for patient data protection</p>
          </motion.div>
          <motion.div 
          ...
          >
            {complianceFeatures.map((feature) => (
              ...
              >
                <motion.div
                  className="w-14 h-14 rounded-xl bg-gray-100 flex items-center justify-center"
      ...
      <section className="py-16 bg-gray-50 border-y border-gray-100">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            {[
              { icon: Stethoscope, name: "GP Practices" },
              { icon: Heart, name: "Cardiology" },
              { icon: Activity, name: "Physio Clinics" },
              { icon: Building2, name: "Private Hospitals" },
              { icon: Users, name: "Dental Practices" },
              { icon: Shield, name: "Mental Health" },
            ].map((clinic) => (
              <motion.div
                key={clinic.name}
                variants={fadeInUp}
      ...
      <section className="py-20 md:py-28 bg-white overflow-hidden relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            >
              Join forward-thinking clinics who are improving patient experience 
              while reducing admin burden. Book a free consultation today.
            </motion.p>
            <motion.div 
              variants={fadeInUp}
