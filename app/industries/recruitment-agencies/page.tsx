...
const solutions = [
  {
    ...
    description: "Find qualified candidates faster with AI-powered sourcing across job boards, LinkedIn, and your existing database. No more manual searching through thousands of profiles.",
    features: [
  ...
  },
  {
    ...
    description: "Extract and structure candidate data instantly. Our AI reads CVs in any format and automatically populates your ATS with accurate, searchable information.",
    features: [
      "Parse any CV format (PDF, Word, etc.)",
      "Skills & experience extraction",
      "Automatic ATS population",
  ...
  },
  {
    ...
    description: "Eliminate the back-and-forth of interview coordination. Candidates self-book into available slots that work for hiring managers and interviewers.",
    features: [
      "Self-service booking links",
      "Multi-timezone support",
      "Panel interview coordination",
      "Automated reminders & prep notes"
    ]
  },
  {
    icon: GitBranch,
    title: "Pipeline Management",
    description: "Track every candidate through your recruitment funnel with visual pipelines. Never lose track of where candidates are in the process.",
    features: [
  ...
  },
  {
    ...
    description: "Scale your candidate engagement with personalised multi-channel sequences. Reach more candidates while maintaining a human touch.",
    features: [
...
const benefits = [
  {
    icon: Clock,
    title: "Cut Time-to-Hire by 50%",
    description: "Automate admin tasks and fill roles faster with streamlined workflows."
  },
  {
    icon: TrendingUp,
    title: "3x Candidate Pipeline",
    description: "Source and engage more candidates without adding headcount."
  },
  {
    icon: UserCheck,
    title: "Better Candidate Experience",
    description: "Fast responses and easy scheduling keep candidates engaged."
  },
  {
    icon: Zap,
    title: "Go Live in Days",
    description: "Quick integration with your existing ATS and tools."
  }
];
...
const workflows = [
  {
    step: "01",
    title: "Source & Parse",
    description: "AI finds candidates and extracts CV data automatically."
  },
  {
    step: "02",
    title: "Screen & Match",
    description: "Candidates scored against job requirements instantly."
  },
  {
    step: "03",
    title: "Engage & Schedule",
    description: "Automated outreach and self-service interview booking."
  },
  {
    step: "04",
    title: "Track & Place",
    description: "Visual pipeline management through to successful placement."
  }
];
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">AI for Recruitment Agencies</span>
            </motion.div>
            ...
            >
              From sourcing to placement, automate the repetitive tasks that slow you down. 
              Spend less time on admin and more time building relationships that close deals.
            </motion.p>
      ...
      <section id="solutions" className="py-20 md:py-28 bg-gray-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Solutions Built for Recruiters
            </motion.h2>
            <motion.p 
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              Every automation designed to help you place more candidates, faster
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <motion.h2 
              ...
              className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
            >
              From Sourcing to Placement, Automated
            </motion.h2>
            <motion.p 
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              See how a typical candidate flows through your automated recruitment pipeline
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 bg-black text-white overflow-hidden relative">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Real results from real recruitment professionals
            </motion.p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInLeft}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Recruiters Are Already Shopping for Automation
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                The recruitment industry knows it needs to automate. Every day, agencies search for 
                tools to help them source faster, screen smarter, and place more candidates. 
                The question isn&apos;t whether to automate—it&apos;s which partner to trust.
              </p>
              <div className="space-y-4">
                {[
                  "Manual sourcing can't keep up with client demands",
                  "CV screening takes hours that could be billing",
                  "Interview scheduling creates friction and drop-offs",
                  "Candidates expect instant, personalised communication"
                ].map((point, index) => (
                  <motion.div
                    key={point}
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 mt-2">UK Recruitment Industry Value</p>
                </div>
                <div className="grid grid-cols-2 gap-4 pt-6 border-t border-gray-100">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">67%</div>
                    <p className="text-sm text-gray-500">Seeking automation tools</p>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">5hrs+</div>
                    <p className="text-sm text-gray-500">Weekly admin per recruiter</p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            {[
              ...
              { icon: GitBranch, name: "ATS Systems" },
              { icon: Target, name: "Job Boards" },
            ].map((integration) => (
              <motion.div
      ...
      <section className="py-20 md:py-28 bg-white overflow-hidden relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            >
              Join forward-thinking recruitment agencies who are filling roles faster 
