...
const solutions = [
  {
    ...
    description: "Capture high-net-worth prospects 24/7 with sophisticated intake forms. Qualify leads based on investable assets, goals, and timeline—automatically routing hot prospects to your team.",
    features: [
      "24/7 prospect capture",
      "Asset-based qualification",
      "Investment goal profiling",
      "Priority lead routing"
    ]
  },
  {
    icon: UserCheck,
    title: "Automated KYC Workflows",
    description: "Streamline Know Your Customer compliance with automated ID verification, document collection, and risk profiling. Stay FCA compliant without the manual burden.",
    features: [
  ...
  {
    icon: ClipboardList,
    title: "Digital Fact Finders",
    description: "Replace paper fact finds with intelligent digital questionnaires. Collect financial circumstances, risk appetite, and objectives through guided conversational flows.",
    features: [
      "Comprehensive financial review",
      "Risk tolerance assessment",
      "Objectives & timeline capture",
      "Auto-populated reports"
    ]
  },
  {
    icon: Calendar,
    title: "Smart Appointment Setting",
    description: "Let prospects book directly into your calendar. AI qualifies and schedules initial consultations, sends reminders, and handles rescheduling—freeing your team for advice.",
    features: [
...
const benefits = [
  {
    ...
    description: "Never miss a high-value prospect—intake runs around the clock."
  },
  {
    icon: Shield,
    title: "FCA & GDPR Ready",
    description: "Built for UK financial services compliance from the ground up."
  },
  {
    icon: TrendingUp,
    title: "Higher Conversion",
    description: "Respond instantly to enquiries—convert more prospects to clients."
  },
  {
    icon: Zap,
    title: "Reduce Admin 70%",
    description: "Automate fact finds, KYC, and scheduling. Focus on advice."
  }
];
...
const workflows = [
  {
    step: "01",
    title: "Prospect Enquires",
    description: "Lead submits details via your website or landing page."
  },
  {
    step: "02",
    title: "AI Qualifies",
    description: "Investable assets, goals, and timeline assessed automatically."
  },
  {
    step: "03",
    title: "Data Collected",
    description: "Fact finder and KYC documentation gathered digitally."
  },
  {
    step: "04",
    title: "Meeting Booked",
    description: "Qualified prospect scheduled directly into your calendar."
  }
];
...
const complianceFeatures = [
  ...
  { icon: UserCheck, label: "AML Ready" },
  { icon: Users, label: "Access Controls" },
];
...
export default function FinancialAdvisorsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">AI for Financial Services</span>
            </motion.div>
            ...
            >
              Lead capture, KYC workflows, digital fact finders, and appointment setting—all 
              automated. Spend less time on admin, more time delivering advice.
            </motion.p>
      ...
      <section id="solutions" className="py-20 md:py-28 bg-gray-50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Every automation designed with FCA compliance and client confidentiality in mind
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <motion.h2 
              ...
              className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"
            >
              From Prospect to Client—Automated
            </motion.h2>
            <motion.p 
              variants={fadeInUp}
              className="text-lg text-gray-600 max-w-2xl mx-auto"
            >
              See how AI streamlines your client acquisition workflow
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 md:py-28 bg-black text-white overflow-hidden relative">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            >
              Trusted by IFAs and wealth managers across the UK
            </motion.p>
          </motion.div>
      ...
      {/* Compliance Section - Unique to Financial Advisors */}
          ...
          >
            <motion.div variants={fadeInLeft}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Built for Regulated Advice
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Financial services demand the highest standards of compliance and data security. 
                Our systems are designed to meet FCA requirements, with full audit trails, 
                encryption, and the documentation regulators expect.
              </p>
              <div className="space-y-4">
                {[
                  "100% audit trail on all client interactions",
                  "Bank-grade encryption for sensitive data",
                  "Automated KYC and AML documentation",
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                <div className="grid grid-cols-3 gap-4">
                  {complianceFeatures.map((feature, index) => (
                    ...
                    >
                      <motion.div
                        className="w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center mb-3"
                ...
                <div className="mt-6 pt-6 border-t border-gray-100 text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Compliance Built-In</p>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">
              Trusted by financial professionals across the UK
            </p>
          </motion.div>
          <motion.div 
          ...
          >
            {[
              { icon: Briefcase, name: "IFAs" },
              { icon: TrendingUp, name: "Wealth Managers" },
              { icon: PiggyBank, name: "Pension Advisors" },
              { icon: LineChart, name: "Investment Managers" },
              { icon: Shield, name: "Protection Advisors" },
              { icon: Users, name: "Financial Planners" },
            ].map((service) => (
              <motion.div
                key={service.name}
                variants={fadeInUp}
      ...
      <section className="py-20 md:py-28 bg-white overflow-hidden relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            >
              Join forward-thinking advisors who are capturing more leads 
              and reducing admin burden. Book a free consultation today.
            </motion.p>
            <motion.div 
              variants={fadeInUp}
